    ...
    <style>
      ...
      * {
      ...
      .title-moment::before {
        ...
        position: absolute;
        inset: 0;
        background: linear-gradient(90deg, transparent, rgba(201, 169, 97, 0.03) 50%, transparent);
        pointer-events: none;
      }
...
<span class="cmd">alchemy</span> deploy</div>
      ...
      <div style="position: relative; margin-top: 80px;">
        ...
        <div style="position: absolute; inset: 0; background-image: url('/cta-bg.jpg'); background-size: cover; background-position: center; background-repeat: no-repeat; z-index: 0;"></div>
        ...
        <!-- Footer above bg -->
        <footer class="shell" style="position: relative; z-index: 10;">
          <div>Open source. MIT licensed. Built for Cloudflare Workers.</div>
        </footer>
      </div>
    </main>
    
    <!-- Gradient overlay to smooth transition -->
    <div style="position: absolute; bottom: 60vh; left: 0; right: 0; height: 200px; background: linear-gradient(to bottom, rgba(10, 10, 10, 1), rgba(10, 10, 10, 0)); z-index: 1; pointer-events: none;"></div>
    
    <!-- Absolute full-bleed background at bottom of page -->
    <div style="position: absolute; bottom: 0; left: 0; right: 0; height: 60vh; background-image: url('/cta-bg.jpg'); background-size: cover; background-position: center; background-repeat: no-repeat; z-index: 0; pointer-events: none;"></div>
  </body>
</html>`;
