...
- `packages/deja-client/tsconfig.json` rootDir: "src" will break if not updated — must be removed
...
- SERVER_ROOT in test must remain `/home/chase/deja`
