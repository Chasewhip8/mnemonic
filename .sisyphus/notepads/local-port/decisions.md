...
- MnemonicService plain class (no DurableObject base) takes db client + drizzle as constructor params
- libSQL file DB at ./data/mnemonic.db (DB_PATH env var)
...
- No marketing site changes, no packages/mnemonic-client changes
